...
```sh
git clone https://github.com/fau/custom-search-filters.git
cd custom-search-filters
...
```sh
pip install dist/custom-search-filters-0.1.0
```
...
| Name | E-mail     |
|------|------------|
| Kai Koebnick | [kai.koebnick@gamil.com](mailto:kai.koebnick@gamil.com)
